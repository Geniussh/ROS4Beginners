...
"""autogenerated by genpy from path_exam/RecordOdomActionFeedback.msg. Do not edit."""
import sys
...
class RecordOdomActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "path_exam/RecordOdomActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','path_exam/RecordOdomFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecordOdomActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = path_exam.msg.RecordOdomFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = path_exam.msg.RecordOdomFeedback()
