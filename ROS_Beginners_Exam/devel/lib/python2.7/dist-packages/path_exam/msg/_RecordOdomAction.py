...
"""autogenerated by genpy from path_exam/RecordOdomAction.msg. Do not edit."""
import sys
...
import path_exam.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class RecordOdomAction(genpy.Message):
  _md5sum = "c10573caa5fde5ccea6a57161065403b"
  _type = "path_exam/RecordOdomAction"
...
"""
  ...
  _slot_types = ['path_exam/RecordOdomActionGoal','path_exam/RecordOdomActionResult','path_exam/RecordOdomActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecordOdomAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = path_exam.msg.RecordOdomActionGoal()
      if self.action_result is None:
        self.action_result = path_exam.msg.RecordOdomActionResult()
      if self.action_feedback is None:
        self.action_feedback = path_exam.msg.RecordOdomActionFeedback()
    else:
      self.action_goal = path_exam.msg.RecordOdomActionGoal()
      self.action_result = path_exam.msg.RecordOdomActionResult()
      self.action_feedback = path_exam.msg.RecordOdomActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.result)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.result:
        _v1 = val1.position
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.action_result.result.result.append(val1)
      _x = self
      start = end
      end += 12
