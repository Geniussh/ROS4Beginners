...
class GurdyJointMover(object):
    ...
    def __init__(self):
        ...
        rospy.loginfo("Gurdy JointMover Initializing...")
    ...
    def gurdy_init_pos_sequence(self):
        """
        UPPER limits lower="-1.56" upper="0.0"
        LOWER limits lower="-2.85" upper="1.56"
        :return:
        """
        upperlegM1_angle = -1.56
        upperlegM2_angle = -1.56
        upperlegM3_angle = -1.56
        ...
        lowerlegM1_angle = -1.56
        lowerlegM2_angle = -1.56
        lowerlegM3_angle = -1.56
        self.gurdy_movement_look(upperlegM1_angle,
                                 upperlegM2_angle,
                                 upperlegM3_angle,
                                 lowerlegM1_angle,
...
if __name__ == "__main__":
    ...
    # gurdy_jointmover_object.gurdy_hop()
    # gurdy_jointmover_object.gurdy_init_pos_sequence()
