...
while not client.wait_for_result():
    ...
    rate.sleep()
# The above log message "doing stuff" will never be printed because
# wait_for_result() will only return a value when the Action has Finished
# which means the while not has never been entered
